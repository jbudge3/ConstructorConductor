...
var user1 = new User('Jake', 'jake.budge@me.com', 'coolPass', 0);
quizUsers.push(user1);

var user2 = new User('Lynsey', 'lynsey.budge@me.com', 'coolerPass', 0);
quizUsers.push(user2);

var user3 = new User('Steve', 'mickeyfickey@me.com', 'imAwesome', 0);
...
var verifyData = function(arr) {
  for (var i = 0; i < arr.length; i++) {
    console.log(arr[i]);
  }
}

verifyData(quizUsers);
verifyData(questions);
